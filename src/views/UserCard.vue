<template>
  ...
  <div class="container">
    ...
    <div class="my-5 row justify-content-center">
      <FormView class="col-md-6" v-slot="{ errors }"
            @submit="createOrder">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <FieldView id="name" name="姓名" type="text" class="form-control"
                   ...
                   v-model="form.user.name"></FieldView>
          <ErrorMessage name="姓名" class="invalid-feedback"></ErrorMessage>
        </div>

        <div class="mb-3">
          <label for="tel" class="form-label">收件人電話</label>
          <FieldView id="tel" name="電話" type="tel" class="form-control"
                   :class="{ 'is-invalid': errors['電話'] }"
                   placeholder="請輸入電話" rules="required"
                   v-model="form.user.tel"></FieldView>
        ...
        <div class="mb-3">
          ...
          <FieldView id="address" name="地址" type="text" class="form-control"
                   ...
                   v-model="form.user.address"></FieldView>
